...
[<img src="Visuals/file-20210604-23-e0is4c.jpeg" width="600" height="300">]
...
[<img src="Visuals/60-seconds-on-the-internet.png" width="600" height="600">]
...
Images were split into Train/Test/Split folders using the `os` and `shutil` libraries. Images were then converted to grayscale to reduce computational complexity. Image quality was reduced to (80 x 80), again for the sake of computation time. 
