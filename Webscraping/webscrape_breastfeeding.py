...
for i in range(1,1000):
    try:
        driver.find_element_by_xpath('//*[@id="islrg"]/div[1]/div['+str(i)+']/a[1]/div[1]/img').screenshot('/Users/samanthabaltodano/nsfw_image_classification/Webscraped Images/Breastfeeding/breastfeeding ('+str(i)+').png')
    except:
        pass